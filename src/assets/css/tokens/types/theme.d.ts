export interface YThemeToken {
  ...
  'cube-block-button-color': string;
  'cube-block-button-text': string;
  'cube-block-button-bg': string;
  'cube-block-button-hover-background': string;
  ...
  'cube-utility-border-theme-heavy': string;
  'cube-utility-border-width-10': string;
  'cube-utility-border-width-25': string;
  'cube-utility-border-width-50': string;
  'cube-utility-border-width-75': string;
